...
export const Curve: FC<ICurveProps> = (props) => {
  ...
  const drawArrow = (ctx: CanvasRenderingContext2D, x1: number, y1: number, x2: number, y2: number): void => {
  ...
  useEffect(() => {
    ...
    if (canvas && props.ethReserve && props.tokenReserve) {
      ...
      if (props.addingEth) {
        ...
        ctx.fillStyle = '#000000';
        ctx.fillText(
          '' + props.addingEth.toString() + ' ETH input',
        ...
        ctx.fillStyle = '#000000';
        ctx.fillText(
          '' + amountGained.toString() + ' 🎈 output (-0.3% fee)',
        ...
        ctx.fillStyle = '#000000';
        ctx.fillText(
          '' + props.addingToken.toString() + ' 🎈 input',
          plotX(props.ethReserve) + textSize,
          plotY(props.tokenReserve)
        );
        ...
        ctx.fillStyle = '#000000';
        ctx.fillText(
          '' + amountGained.toString() + ' ETH output (-0.3% fee)',
